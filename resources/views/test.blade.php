...
<aside class="sidebar-left-collapse">
  <div class="sidebar-links">
    <div class="link-blue selected"> <a href="{{route('addbusowners')}}"> <i class="fa fa-picture-o"></i>Add bus owner </a> </div>
...
<div class="main-agileinfo" id="addbusowner" style="width:450px;">
  <ul class="resp-tabs-list">
    <li class="resp-tab-item"><span style="color:#000000">Add bus owner</span></li>
  </ul>
  ...
  <div class="resp-tabs-container">
    <form action='{{route('enterBusOwnerData')}}' method="post">
      <div class='clear'>
        <h3> Owners ID</h3>
        <input type="text" autocomplete="off" placeholder="ID" name="ID" id="ID" required/>
      </div>
      <div class='clear'>
      <br>
      <h3> Owners Name</h3>
      ...
      <div class='clear'>
      <br>
      <h3> Owners Password</h3>
      <input type="password" style="height:35px; width:390px;" id="password1" placeholder="Password" name="password" required/>
      </div>
      <div class='clear'>
      <br>
      <h3> Password Reenter</h3>
      <input type="password" style="height:35px; width:390px;" placeholder="Password" id="password2" name="password" required/>
      <div class="passwordntM" id="passwordntM" style="color:#D8FF00"></div>
      </div>
      <input type="hidden" name="_token" value="{{ Session::token() }}">
      <div class ="centerone" style="text-align:center">
      <input type="submit" value="Add bus owner">
      </div>
    </form>
  </div>
</div>
