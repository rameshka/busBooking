...
<aside class="sidebar-left-collapse">
  <div class="sidebar-links">
    ...
    <div class="link-green selected"> <a href="{{route('getrouets')}}"> <i class="fa fa-map-marker"></i>View Routes </a> </div>
  </div>
</aside>
    <table  >
        <tr >
            <th>Route ID&emsp; </th>
            <th>&nbsp Route Name &emsp; </th>
            <th> Route No </th>
			<th> Time Interval </th>
        </tr>
<?php $d=0;?>
        @foreach($result as $owner)
            ...
            <tr id =<?php echo $d; ?>>
                ...
                <td id="tripID">{!! $owner->route_no!!}&emsp;&emsp;</td>
                <td id="tripID1">{!! $owner->timeinterval!!}&emsp;&emsp;</td>
...
<div class="main-agileinfo" style="width:400px" id="Reservation">
  <ul class="resp-tabs-list">
    <li class="resp-tab-item"><span style="color:#000000">Search Routes</span></li>
  </ul>
